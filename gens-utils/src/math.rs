...
#[test]
fn exp_test() {
    assert_gens_fx64!(fx64!(1, 0).exp().unwrap(), fx64!(2, 718281828), 7)
}
...
fn pow_test() {
    ...
    assert_gens_fx64!(actual, expected, 4);
}
...
fn pow_test_e() {
    ...
    assert_gens_fx64!(actual, expected, 3);
}
...
fn sqrt_test_small_num() {
    ...
    assert_gens_fx64!(actual, expected, 5);
}
