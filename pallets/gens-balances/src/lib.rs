...
pub use gens_primitives::currency;
use gens_primitives::currency::Currency;
...
pub trait GensCurrency<AccountId, Balance>
where
    Balance: Member
        + AtLeast32BitUnsigned
        + FullCodec
...
impl<T: Trait> GensCurrency<T::AccountId, T::Balance> for Module<T> {
